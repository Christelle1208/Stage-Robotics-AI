...
class SO100BaseEnv(gym.Env):
    ...
    def _reset_mujoco(self, seed: int | None):
        ...
        # Randomise object XY on ground in front of robot (±7 cm around default pos)
        obj_base = self.model.body("object").pos.copy()
        obj_pos = np.array([
            obj_base[0] + self.np_random.uniform(-0.07, 0.07),
            obj_base[1] + self.np_random.uniform(-0.07, 0.07),

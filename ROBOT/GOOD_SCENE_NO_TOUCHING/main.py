...
xml_path = os.path.join(os.path.dirname(__file__), "scene_pick_place.xml")
...
# motion_planner = RRT(env.joint_limits[:5], step_size=(0.05,), max_iter=2500)
motion_planner = RRTStar(env.joint_limits[:5], step_size=(0.05,), max_iter=2500, neighbor_radius=0.25)
